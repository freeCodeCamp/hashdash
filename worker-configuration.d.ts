/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4389f705f7d929741a93d503400411da)
// Runtime types generated with workerd@1.20260219.0 2026-02-20 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/_worker.js/index");
		durableNamespaces: "PostIndexer";
	}
	interface Env {
		POSTS_DB: D1Database;
		ASSETS: Fetcher;
		HASHNODE_HOST: "fcc.hashnode.dev";
		HASHNODE_API_URL: "https://gql-beta.hashnode.com/";
		HASHNODE_TOKEN: string;
		WEBHOOK_SECRET: string;
		LIVE_MODE: string;
		POST_INDEXER: DurableObjectNamespace<import("./dist/_worker.js/index").PostIndexer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HASHNODE_HOST" | "HASHNODE_API_URL" | "HASHNODE_TOKEN" | "WEBHOOK_SECRET" | "LIVE_MODE">> {}
}
